...
<center>
 <h1> Welcome To The Update Page</h1>
  <div class="container">
    <label for="code"><b>Enter the Customer Code you want to Update:</b></label>
    <input type="text" placeholder="Enter Code" name="code" required>

    <button type="submit" name="button1" value="update" >Submit</button>
...
<h2>Enter the Customer Code you want to Update:</h2> <input type="text" name=code>
