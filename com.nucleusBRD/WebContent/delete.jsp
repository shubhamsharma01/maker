...
<center>
 <h1> Welcome To The Delete Page</h1>
  <div class="container">
    <label for="code"><b>Enter the customer code to delete</b></label>
    <input type="text" placeholder="Enter Code" name="code" required>

    <button type="submit" name="button1" value="Delete" >Submit</button>
...
<form action="CustController" method="post">
<center>
<h2> Enter the Customer Code to Delete</h2>
